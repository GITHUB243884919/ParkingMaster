...
namespace UFrame.OrthographicCamera
{
    public class TraceCamera : SingletonMono<TraceCamera>
    {
        ...
        public Vector3 pos { get { return cachedTrans.position; } set { cachedTrans.position = value; } }
        ...
        public void BeginTrace(Transform traceTrans, bool isLookAtScreenCenter = true)
        {
            if (traceTrans == null)
            {
                return;
            }
            if (isLookAtScreenCenter)
            {
